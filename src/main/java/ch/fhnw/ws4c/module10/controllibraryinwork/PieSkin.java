 ...
 * @author Dieter Holz
 */
class PieSkin extends SkinBase<NumberRangeControl> { // ToDo: angeben welcher Controll
	private static final String FONTS_CSS = "fonts.css";
	private static final String STYLE_CSS = "pieStyle.css";

	private static final double PREFERRED_WIDTH  = 130;
	...
	PieSkin(NumberRangeControl control) { // ToDo: angeben welches Control
		super(control);
		init();
		initializeParts();
		layoutParts();
	...
	private void addBindings() {
		pieSlice.lengthProperty().bind(getSkinnable().angleProperty()); // ToDo: binding angeben...
	}
