package ch.fhnw.ws4c.module06.statusiconsolution;
	...
	private void addValueChangedListeners() {
		statusProperty().addListener((observable, oldValue, newValue) -> {
			...
			KeyFrame kf = new KeyFrame(Duration.millis(200),
			                           new KeyValue(line1.startXProperty(), newValue.getLine1Start().getX()),
			                           new KeyValue(line1.startYProperty(), newValue.getLine1Start().getY()),
			                           new KeyValue(line1.endXProperty(), newValue.getLine1End().getX()),
			                           new KeyValue(line1.endYProperty(), newValue.getLine1End().getY()),

			                           new KeyValue(line2.startXProperty(), newValue.getLine2Start().getX()),
			                           new KeyValue(line2.startYProperty(), newValue.getLine2Start().getY()),
			                           new KeyValue(line2.endXProperty(), newValue.getLine2End().getX()),
			                           new KeyValue(line2.endYProperty(), newValue.getLine2End().getY()),

			                           new KeyValue(line3.startXProperty(), newValue.getLine3Start().getX()),
			                           new KeyValue(line3.startYProperty(), newValue.getLine3Start().getY()),
			                           new KeyValue(line3.endXProperty(), newValue.getLine3End().getX()),
			                           new KeyValue(line3.endYProperty(), newValue.getLine3End().getY())
			);
